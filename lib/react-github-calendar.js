...
var ReactGithubCalendar = function (_Component) {
  ...
  function ReactGithubCalendar() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = ReactGithubCalendar.__proto__ || Object.getPrototypeOf(ReactGithubCalendar)).call.apply(_ref, [this].concat(args))), _this), _this.PropTypes = {
    ...
    value: function render() {
      ...
      return _react2.default.createElement('div', _extends({
        ...
        ref: function ref(dom) {
          (0, _githubCalendar2.default)(dom, _this2.props.name);
        }
      }));
    }
  }]);
